...
import io.swagger.client.model.UserStatusCreate;
...
public class UserCreate {
  ...
  private AllOfUserCreateDataLimitResetStrategy dataLimitResetStrategy = null;
  ...
  private UserStatusCreate status = null;

  public UserCreate proxies(Map<String, ProxySettings> proxies) {
    this.proxies = proxies;
    return this;
  }

  public UserCreate putProxiesItem(String key, ProxySettings proxiesItem) {
  ...
  **/
  ...
  public UserCreate expire(Integer expire) {
    this.expire = expire;
    return this;
  }
  ...
  **/
  ...
  public UserCreate dataLimit(Integer dataLimit) {
  ...
  **/
  ...
  public UserCreate dataLimitResetStrategy(AllOfUserCreateDataLimitResetStrategy dataLimitResetStrategy) {
  ...
  **/
  @Schema(description = "")
  public AllOfUserCreateDataLimitResetStrategy getDataLimitResetStrategy() {
    return dataLimitResetStrategy;
  }

  public void setDataLimitResetStrategy(AllOfUserCreateDataLimitResetStrategy dataLimitResetStrategy) {
    this.dataLimitResetStrategy = dataLimitResetStrategy;
  }

  public UserCreate inbounds(Map<String, List<String>> inbounds) {
    this.inbounds = inbounds;
    return this;
  }

  public UserCreate putInboundsItem(String key, List<String> inboundsItem) {
  ...
  **/
  ...
  public UserCreate note(String note) {
    this.note = note;
    return this;
  }
  ...
  **/
  ...
  public UserCreate subUpdatedAt(OffsetDateTime subUpdatedAt) {
  ...
  **/
  ...
  public UserCreate subLastUserAgent(String subLastUserAgent) {
  ...
  **/
  ...
  public UserCreate onlineAt(OffsetDateTime onlineAt) {
  ...
  **/
  ...
  public UserCreate onHoldExpireDuration(Integer onHoldExpireDuration) {
  ...
  **/
  ...
  public UserCreate onHoldTimeout(OffsetDateTime onHoldTimeout) {
  ...
  **/
  ...
  public UserCreate autoDeleteInDays(Integer autoDeleteInDays) {
  ...
  **/
  ...
  public UserCreate status(UserStatusCreate status) {
    this.status = status;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public UserStatusCreate getStatus() {
    return status;
  }

  public void setStatus(UserStatusCreate status) {
    this.status = status;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.proxies, userCreate.proxies) &&
        Objects.equals(this.expire, userCreate.expire) &&
        Objects.equals(this.dataLimit, userCreate.dataLimit) &&
        Objects.equals(this.dataLimitResetStrategy, userCreate.dataLimitResetStrategy) &&
        Objects.equals(this.inbounds, userCreate.inbounds) &&
        Objects.equals(this.note, userCreate.note) &&
        Objects.equals(this.subUpdatedAt, userCreate.subUpdatedAt) &&
        Objects.equals(this.subLastUserAgent, userCreate.subLastUserAgent) &&
        Objects.equals(this.onlineAt, userCreate.onlineAt) &&
        Objects.equals(this.onHoldExpireDuration, userCreate.onHoldExpireDuration) &&
        Objects.equals(this.onHoldTimeout, userCreate.onHoldTimeout) &&
        Objects.equals(this.autoDeleteInDays, userCreate.autoDeleteInDays) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(proxies, expire, dataLimit, dataLimitResetStrategy, inbounds, note, subUpdatedAt, subLastUserAgent, onlineAt, onHoldExpireDuration, onHoldTimeout, autoDeleteInDays, username, status);
  }
